 ...
 */
class ItemContentMinSuTwoVM (mybeans:List<MinSuAndLifeContentItem>): RecyclerItemVM<List<MinSuAndLifeContentItem>?>() {
    ...
    override fun loadItemView(): Int = R.layout.item_minsu_content_two

    class MinSuItemVMFactory : ItemVMFactory<MinSuAndLifeContentItem>() {
        override fun getItemVM(viewType: Int): RecyclerItemVM<MinSuAndLifeContentItem> = ItemContentMinSuTwoVMItem()
    }
