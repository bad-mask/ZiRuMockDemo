 ...
 */
class ItemContentMinSuThreeVM(mybeans: List<MinSuContentItem>) : RecyclerItemVM<List<MinSuContentItem>?>() {
    ...
    class MinSuItemVMFactory : ItemVMFactory<MinSuContentItem>() {
        override fun getItemVM(viewType: Int): RecyclerItemVM<MinSuContentItem> = ItemContentMinSuThreeVMItem()
    }
